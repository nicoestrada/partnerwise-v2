...
const SearchResults: React.FC = () => {
    ...
    console.log(searchParams.has("avgProductPrice"))
  ...
  return (
    <div className="tabs flex-col relative mt-6 text-center overflow-x-auto whitespace-nowrap">
      <div className="flex overflow-x-auto border-b border-gray-200 mx-auto bg-base-100 w-full whitespace-nowrap scrollbar-thin scrollbar-thumb-gray-40">
      </div>
