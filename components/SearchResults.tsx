...
const SearchResults: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const fetchURLBrands = async () => {
            setIsLoading(true);
            try {
                const data = await getURLBrands();
                setBrands(data);
            } catch (error) {
                console.error(error);
                setBrands([]);
        ...
        fetchURLBrands();
    }, [searchParams]); // Depend on searchParams to ensure updates trigger a re-fetch
  ...
  return (
    <div className="tabs flex-col relative mt-6 text-center overflow-x-auto whitespace-nowrap">
      <div ref={tabContainerRef} className="flex overflow-x-auto border-b border-gray-200 mx-auto bg-base-100 w-full whitespace-nowrap scrollbar-thin scrollbar-thumb-gray-40">
        <button
          ...
          className={`px-4 py-2 ml-2 font-medium ${
            activeTab === 0 ? 'text-gray-800 border-b-2 border-purple-500' : 'text-gray-400 hover:text-slate-800 hover:border-b-2 hover:cursor-pointer hover:bg-base-200 hover:rounded-lg'
          }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 font-medium ${
            activeTab === 1 ? 'text-gray-800 border-b-2 border-purple-500' : 'text-gray-400 hover:text-slate-800 hover:border-b-2 hover:cursor-pointer hover:bg-base-200 hover:rounded-lg'
          }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 font-medium ${
            activeTab === 2 ? 'text-gray-800 border-b-2 border-purple-500' : 'text-gray-400 hover:text-slate-800 hover:border-b-2 hover:cursor-pointer hover:bg-base-200 hover:rounded-lg'
          }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 font-medium ${
            activeTab === 3 ? 'text-gray-800 border-b-2 border-purple-500' : 'text-gray-400 hover:text-slate-800 hover:border-b-2 hover:cursor-pointer hover:bg-base-200 hover:rounded-lg'
          }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 font-medium ${
            activeTab === 4 ? 'text-gray-800 border-b-2 border-purple-500' : 'text-gray-400 hover:text-slate-800 hover:border-b-2 hover:cursor-pointer hover:bg-base-200 hover:rounded-lg'
          }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 font-medium ${
            activeTab === 5 ? 'text-gray-800 border-b-2 border-purple-500' : 'text-gray-400 hover:text-slate-800 hover:border-b-2 hover:cursor-pointer hover:bg-base-200 hover:rounded-lg'
          }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 font-medium ${
            activeTab === 6 ? 'text-gray-800 border-b-2 border-purple-500' : 'text-gray-400 hover:text-slate-800 hover:border-b-2 hover:cursor-pointer hover:bg-base-200 hover:rounded-lg'
          }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 font-medium ${
            activeTab === 7 ? 'text-gray-800 border-b-2 border-purple-500' : 'text-gray-400 hover:text-slate-800 hover:border-b-2 hover:cursor-pointer hover:bg-base-200 hover:rounded-lg'
          }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 font-medium ${
            activeTab === 8 ? 'text-gray-800 border-b-2 border-purple-500' : 'text-gray-400 hover:text-slate-800 hover:border-b-2 hover:cursor-pointer hover:bg-base-200 hover:rounded-lg'
          }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 font-medium ${
            activeTab === 9 ? 'text-gray-800 border-b-2 border-purple-500' : 'text-gray-400 hover:text-slate-800 hover:border-b-2 hover:cursor-pointer hover:bg-base-200 hover:rounded-lg'
          }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 font-medium ${
            activeTab === 10 ? 'text-gray-800 border-b-2 border-purple-500' : 'text-gray-400 hover:text-slate-800 hover:border-b-2 hover:cursor-pointer hover:bg-base-200 hover:rounded-lg'
          }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 font-medium ${
            activeTab === 11 ? 'text-gray-800 border-b-2 border-purple-500' : 'text-gray-400 hover:text-slate-800 hover:border-b-2 hover:cursor-pointer hover:bg-base-200 hover:rounded-lg'
          }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 font-medium ${
            activeTab === 12 ? 'text-gray-800 border-b-2 border-purple-500' : 'text-gray-400 hover:text-slate-800 hover:border-b-2 hover:cursor-pointer hover:bg-base-200 hover:rounded-lg'
          }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 font-medium ${
            activeTab === 13 ? 'text-gray-800 border-b-2 border-purple-500' : 'text-gray-400 hover:text-slate-800 hover:border-b-2 hover:cursor-pointer hover:bg-base-200 hover:rounded-lg'
          }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 font-medium ${
            activeTab === 14 ? 'text-gray-800 border-b-2 border-purple-500' : 'text-gray-400 hover:text-slate-800 hover:border-b-2 hover:cursor-pointer hover:bg-base-200 hover:rounded-lg'
          }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 font-medium ${
            activeTab === 15 ? 'text-gray-800 border-b-2 border-purple-500' : 'text-gray-400 hover:text-slate-800 hover:border-b-2 hover:cursor-pointer hover:bg-base-200 hover:rounded-lg'
          }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 font-medium ${
            activeTab === 16 ? 'text-gray-800 border-b-2 border-purple-500' : 'text-gray-400 hover:text-slate-800 hover:border-b-2 hover:cursor-pointer hover:bg-base-200 hover:rounded-lg'
          }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 font-medium ${
            activeTab === 17 ? 'text-gray-800 border-b-2 border-purple-500' : 'text-gray-400 hover:text-slate-800 hover:border-b-2 hover:cursor-pointer hover:bg-base-200 hover:rounded-lg'
          }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 font-medium ${
            activeTab === 18 ? 'text-gray-800 border-b-2 border-purple-500' : 'text-gray-400 hover:text-slate-800 hover:border-b-2 hover:cursor-pointer hover:bg-base-200 hover:rounded-lg'
          }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 font-medium ${
            activeTab === 19 ? 'text-gray-800 border-b-2 border-purple-500' : 'text-gray-400 hover:text-slate-800 hover:border-b-2 hover:cursor-pointer hover:bg-base-200 hover:rounded-lg'
          }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 font-medium ${
            activeTab === 20 ? 'text-gray-800 border-b-2 border-purple-500' : 'text-gray-400 hover:text-slate-800 hover:border-b-2 hover:cursor-pointer hover:bg-base-200 hover:rounded-lg'
          }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 font-medium ${
            activeTab === 21 ? 'text-gray-800 border-b-2 border-purple-500' : 'text-gray-400 hover:text-slate-800 hover:border-b-2 hover:cursor-pointer hover:bg-base-200 hover:rounded-lg'
          }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 font-medium ${
            activeTab === 22 ? 'text-gray-800 border-b-2 border-purple-500' : 'text-gray-400 hover:text-slate-800 hover:border-b-2 hover:cursor-pointer hover:bg-base-200 hover:rounded-lg'
          }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 font-medium ${
            activeTab === 23 ? 'text-gray-800 border-b-2 border-purple-500' : 'text-gray-400 hover:text-slate-800 hover:border-b-2 hover:cursor-pointer hover:bg-base-200 hover:rounded-lg'
          }`}
        >
      ...
      {!isLoading ? <div className="mx-auto justify-center mt-4">
        ...
        <div className={`${activeTab === 24 ? 'block' : 'hidden'}`}>
          <BrandFeedLayout brands={brands} />
        </div>
