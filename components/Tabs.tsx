      ...
      <div ref={tabContainerRef} className="border-b border-gray-200 mx-auto justify-center bg-base-100 w-full">
        <button
          ...
          className={`px-4 py-2 ml-2 font-medium ${
            activeTab === 0 ? 'text-gray-800 border-b-2 border-blue-500' : 'text-gray-400 font-gray-500 hover:text-gray-800 hover:border-b-2 hover:cursor-pointer hover:bg-base-200'
          }`}
        >
            ...
            <p className="text-gray-500 text-xs mt-2 mx-auto hover:text-gray-800 ">Apparel</p>
        </button>
        <button
        ...
        >
            ...
            <p className="text-slate-800 text-xs mt-2 mx-auto">Beauty</p>
        </button>
        <button
        ...
        <button
          ...
          className={`px-4 py-2 font-medium ${
            activeTab === 9 ? 'text-gray-800 border-b-2 border-blue-500' : 'text-gray-500'
          }`}
        >
            ...
            <p className="text-slate-800 text-xs mt-2 mx-auto">Games</p>
        </button>
        <button
          onClick={() => handleTabClick(10)}
          className={`px-4 py-2 font-medium ${
            activeTab === 10 ? 'text-gray-800 border-b-2 border-blue-500' : 'text-gray-500'
          }`}
        >
            ...
            <p className="text-slate-800 text-xs mt-2 mx-auto">Gifts</p>
        </button>
        <button
          onClick={() => handleTabClick(11)}
          className={`px-4 py-2 font-medium ${
            activeTab === 11 ? 'text-gray-800 border-b-2 border-blue-500' : 'text-gray-500'
          }`}
        >
            ...
            <p className="text-slate-800 text-xs mt-2 mx-auto">Health</p>
        </button>
        <button
          onClick={() => handleTabClick(12)}
          className={`px-4 py-2 font-medium ${
            activeTab === 12 ? 'text-gray-800 border-b-2 border-blue-500' : 'text-gray-500'
          }`}
        >
            ...
            <p className="text-slate-800 text-xs mt-2 mx-auto">Holidays</p>
        </button>
        <button
          onClick={() => handleTabClick(13)}
          className={`px-4 py-2 font-medium ${
            activeTab === 13 ? 'text-gray-800 border-b-2 border-blue-500' : 'text-gray-500'
          }`}
        >
            ...
            <p className="text-slate-800 text-xs mt-2 mx-auto">Home</p>
        </button>
        <button
          onClick={() => handleTabClick(14)}
          className={`px-4 py-2 font-medium ${
            activeTab === 14 ? 'text-gray-800 border-b-2 border-blue-500' : 'text-gray-500'
          }`}
        >
            ...
            <p className="text-slate-800 text-xs mt-2 mx-auto">People</p>
        </button>
        <button
          onClick={() => handleTabClick(15)}
          className={`px-4 py-2 font-medium ${
            activeTab === 15 ? 'text-gray-800 border-b-2 border-blue-500' : 'text-gray-500'
          }`}
        >
            ...
            <p className="text-slate-800 text-xs mt-2 mx-auto">Pets</p>
        </button>
        <button
          onClick={() => handleTabClick(16)}
          className={`px-4 py-2 font-medium ${
            activeTab === 16 ? 'text-gray-800 border-b-2 border-blue-500' : 'text-gray-500'
          }`}
        >
            ...
            <p className="text-slate-800 text-xs mt-2 mx-auto">Video</p>
        </button>
        <button
          onClick={() => handleTabClick(17)}
          className={`px-4 py-2 font-medium ${
            activeTab === 17 ? 'text-gray-800 border-b-2 border-blue-500' : 'text-gray-500'
          }`}
        >
            ...
            <p className="text-slate-800 text-xs mt-2 mx-auto">Safety</p>
        </button>
        <button
          onClick={() => handleTabClick(18)}
          className={`px-4 py-2 font-medium ${
            activeTab === 18 ? 'text-gray-800 border-b-2 border-blue-500' : 'text-gray-500'
          }`}
        >
            ...
            <p className="text-slate-800 text-xs mt-2 mx-auto">Science</p>
        </button>
        <button
          onClick={() => handleTabClick(19)}
          className={`px-4 py-2 font-medium ${
            activeTab === 19 ? 'text-gray-800 border-b-2 border-blue-500' : 'text-gray-500'
          }`}
        >
            ...
            <p className="text-slate-800 text-xs mt-2 mx-auto">Smoking</p>
        </button>
        <button
          onClick={() => handleTabClick(20)}
          className={`px-4 py-2 font-medium ${
            activeTab === 20 ? 'text-gray-800 border-b-2 border-blue-500' : 'text-gray-500'
          }`}
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-meda mx-auto"><path d="M7.21 15 2.66 7.14a2 2 0 0 1 .13-2.2L4.4 2.8A2 2 0 0 1 6 2h12a2 2 0 0 1 1.6.8l1.6 2.14a2 2 0 0 1 .14 2.2L16.79 15"/><path d="M11 12 5.12 2.2"/><path d="m13 12 5.88-9.8"/><path d="M8 7h8"/><circle cx="12" cy="17" r="5"/><path d="M12 18v-2h-.5"/></svg>
            <p className="text-slate-800 text-xs mt-2 mx-auto">Sports</p>
        </button>
        <button
          onClick={() => handleTabClick(21)}
          className={`px-4 py-2 font-medium ${
            activeTab === 21 ? 'text-gray-800 border-b-2 border-blue-500' : 'text-gray-500'
          }`}
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-toy-brick mx-auto"><rect width="18" height="12" x="3" y="8" rx="1"/><path d="M10 8V5c0-.6-.4-1-1-1H6a1 1 0 0 0-1 1v3"/><path d="M19 8V5c0-.6-.4-1-1-1h-3a1 1 0 0 0-1 1v3"/></svg>
            <p className="text-slate-800 text-xs mt-2 mx-auto">Toys</p>
        </button>
        <button
          onClick={() => handleTabClick(22)}
          className={`px-4 py-2 font-medium ${
            activeTab === 22 ? 'text-gray-800 border-b-2 border-blue-500' : 'text-gray-500'
          }`}
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-plane-takeoff mx-auto"><path d="M2 22h20"/><path d="M6.36 17.4 4 17l-2-4 1.1-.55a2 2 0 0 1 1.8 0l.17.1a2 2 0 0 0 1.8 0L8 12 5 6l.9-.45a2 2 0 0 1 2.09.2l4.02 3a2 2 0 0 0 2.1.2l4.19-2.06a2.41 2.41 0 0 1 1.73-.17L21 7a1.4 1.4 0 0 1 .87 1.99l-.38.76c-.23.46-.6.84-1.07 1.08L7.58 17.2a2 2 0 0 1-1.22.18Z"/></svg>
            <p className="text-slate-800 text-xs mt-2 mx-auto">Travel</p>
        </button>
        <button
          onClick={() => handleTabClick(23)}
          className={`px-4 py-2 font-medium ${
            activeTab === 23 ? 'text-gray-800 border-b-2 border-blue-500' : 'text-gray-500'
          }`}
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-church mx-auto"><path d="m18 7 4 2v11a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V9l4-2"/><path d="M14 22v-4a2 2 0 0 0-2-2v0a2 2 0 0 0-2 2v4"/><path d="M18 22V5l-6-3-6 3v17"/><path d="M12 7v5"/><path d="M10 9h4"/></svg>
            <p className="text-slate-800 text-xs mt-2 mx-auto">Wedding</p>
        </button>
      </div>
