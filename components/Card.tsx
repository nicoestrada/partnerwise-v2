export default function Card({ brand }) {
    ...
    return (
        <>
            <div className="card w-96 mx-auto my-8 mx-8 border hover:cursor-pointer hover:shadow-xl">
                <figure className="relative">
                    <img src={brand["OG image"]} alt={brand["URL"]+" hero image"} className="rounded-xl w-96 h-80"/>
                    <div className="badge bg-gray-100 text-gray-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-xl dark:bg-pink-900 dark:text-pink-300 absolute m-2 top-0 left-0">{brand["Category"]}</div>     
                </figure>
